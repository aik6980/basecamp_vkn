...
class TextureDataGenerator {
  public:
    static TextureData create_checkerboard_texture(int texture_width, const glm::u8vec4& colour1, const glm::u8vec4& colour2);
    static TextureData create_checkerboard_texture_default(int texture_width);
    static TextureData create_solid_texture(int texture_width, const glm::u8vec4& colour);
